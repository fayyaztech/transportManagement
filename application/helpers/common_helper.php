<?php 
	...
	function freight_calculator($load_type,$km,$freight_rate,$cmvr){
		/*
		* loadtype C50,C55 vehical
		* km of route
		* freight rate on current route
		* crvm rate provided by the user
		*/
		...
		switch ($load_type) {
			...
			case "C14":
				...
				break;
			case "A14":
				$resp = $km*($freight_rate/14*14);
				break;
			case "A18":
				$resp = $km*($freight_rate/14*18);
				break;
			case "A20":
				$resp = $km*($freight_rate/14*20);
				break;
